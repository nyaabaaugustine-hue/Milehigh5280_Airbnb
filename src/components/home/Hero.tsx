    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(to bottom, rgba(8,8,8,0.25) 0%, rgba(8,8,8,0.5) 50%, rgba(8,8,8,0.95) 100%)' }}
        />
        <div
          className="absolute inset-0 z-10"
          style={{ background: 'linear-gradient(to right, rgba(8,8,8,0.65) 0%, transparent 60%)' }}
        />
      </div>
      ...
      <div className="absolute top-1/3 right-12 lg:right-24 hidden lg:flex flex-col items-center gap-4 z-20">
        ...
        <span className="section-label opacity-60" style={{ writingMode: 'vertical-rl', textOrientation: 'mixed' }}>
          Ayi Mensah · Ghana
        </span>
        <div className="w-px h-24 bg-gradient-to-b from-transparent via-[var(--gold)] to-transparent opacity-40" />
      </div>
