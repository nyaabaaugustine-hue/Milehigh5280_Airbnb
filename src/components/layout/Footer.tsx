          ...
          <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr]">
            ...
            <div className="flex flex-col justify-center px-8 lg:px-12 py-12 border-b lg:border-b-0 lg:border-r border-[var(--border)] bg-[var(--surface-2)]">
              ...
              <p className="text-[var(--text-muted)] text-sm leading-relaxed mb-6">
                Nestled in the serene, lush hills of Ayi Mensah — a hidden gem just 30 minutes from Accra city centre. Easy access, peaceful escape.
              </p>
              <div className="space-y-3 mb-6">
                {[
                  ...
                  <div key={label} className="flex items-start gap-3 text-sm">
                    <span className="text-[var(--text-subtle)] min-w-[90px]">{label}</span>
            ...
            <div className="relative h-72 lg:h-auto min-h-[300px] overflow-hidden">
              ...
              {/* Corner vignette */}
              <div className="absolute inset-0 pointer-events-none" style={{ background: 'linear-gradient(135deg, rgba(8,8,8,0.35) 0%, transparent 50%, rgba(8,8,8,0.35) 100%)' }} />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-3 mb-6 group">
              ...
              <div className="flex flex-col leading-none">
                <span className="font-serif text-xl font-light text-white group-hover:text-[var(--gold)] transition-colors">Milehigh5280 🌴</span>
