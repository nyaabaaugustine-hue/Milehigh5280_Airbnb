...
const WA_LINK = 'https://wa.me/233541988383?text=Hello%2C%20I%27d%20like%20to%20enquire%20about%20The%20Palm%20apartment';
      ...
      <section className="py-24 lg:py-36 px-6 lg:px-12 max-w-[1440px] mx-auto">
        <div className="flex flex-col lg:flex-row items-start gap-16">
          ...
          <div className="lg:w-2/5 lg:pt-4">
            ...
            <div className="flex items-center gap-3 p-4 bg-[var(--surface-2)] border border-[var(--border)] mb-6">
              <MapPin size={16} className="text-[var(--gold)] shrink-0" />
              <div>
                <p className="text-[var(--text-primary)] text-sm font-medium">The Palm 🌴</p>
              ...
              <div className="ml-auto flex items-center gap-1">
                ...
                <span className="text-[var(--text-primary)] text-xs font-medium">4.92</span>
              </div>
            </div>
            <button onClick={openBooking} className="btn-gold">
              <Phone size={13} />
          ...
          <div className="lg:w-3/5 w-full">
            <div className="overflow-hidden border border-[var(--border)] shadow-2xl">
              {/* Browser-bar decoration */}
              <div className="bg-[var(--surface-2)] border-b border-[var(--border)] px-4 py-2.5 flex items-center gap-2">
                <div className="flex gap-1.5">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#FF5F57]" />
                  <div className="w-2.5 h-2.5 rounded-full bg-[#FEBC2E]" />
                  <div className="w-2.5 h-2.5 rounded-full bg-[#28C840]" />
                </div>
                <div className="flex-1 bg-[var(--surface-3)] rounded-sm px-3 py-1 text-[0.6rem] text-[var(--text-subtle)] tracking-wide truncate">
                  The Palm 🌴 · Ayi Mensah by Rehoboth Properties
                </div>
              </div>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3969.4431750837834!2d-0.18171132501305962!3d5.792905194189853!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf775ee9a8b2ad%3A0xbeeaf9c2791d4a48!2sThe%20Palm%20%F0%9F%8C%B4%20Ayi%20mensah%20By%20Rehoboth%20Properties!5e0!3m2!1sen!2sgh!4v1775298220437!5m2!1sen!2sgh"
                width="100%"
                height="440"
                ...
                title="The Palm - Ayi Mensah on Google Maps"
              />
            </div>
            <p className="text-[var(--text-subtle)] text-xs mt-3 text-center tracking-wide">
              📍 Click the map to open in Google Maps and get directions
            </p>
          </div>
        </div>
      </section>
