    ...
    <>
      ...
      <section className="relative min-h-[70vh] flex items-end pb-20 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=2000&q=90"
      ...
      <section className="py-24 px-6 lg:px-12 max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            {/* Gold accent corner */}
            <div className="absolute -bottom-4 -left-4 w-24 h-24 border border-[var(--gold)] opacity-30 z-0" />
          </div>
        </div>
      </section>
