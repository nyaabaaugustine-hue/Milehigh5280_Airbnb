          ...
          <div>
            ...
            <div className="border-b border-[var(--border)] pb-8 mb-8">
              ...
              <div className="flex items-center gap-3 mb-4">
                {property.isLive === false && (
                  <span className="bg-obsidian text-[var(--gold)] border border-[var(--gold)] text-[0.6rem] uppercase tracking-widest px-3 py-1 font-semibold">
                    Coming Soon
                  </span>
                )}
                {property.badge && (
                  <span className="bg-[var(--gold)] text-obsidian text-[0.6rem] uppercase tracking-widest px-3 py-1 font-semibold">
                    {property.badge}
                  </span>
                )}
                <span className="text-[var(--text-muted)] text-xs uppercase tracking-widest capitalize">
                  {property.type}
                </span>
              </div>

              <h1 className="font-serif text-4xl lg:text-6xl font-light text-white mb-3">
                {property.name}
              </h1>
              <p className="font-serif text-xl italic text-[var(--gold)] mb-4">
                {property.tagline}
              </p>
            ...
            <div className="mb-10">
              ...
              {property.longDescription.split('\n\n').map((para, i) => (
                <p key={i} className="text-[var(--text-muted)] leading-relaxed mb-4 text-[0.95rem]">
                  {para}
                </p>
              ))}
            </div>
                    ...
                    <div key={key}>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        {items.map(amenity => (
                          <div
                            key={amenity.id}
                            className="flex items-center gap-3 border border-[var(--border)] p-3 hover:border-[var(--gold)] transition-colors duration-300"
                          >
                ...
                <>
                  <div className="border border-[var(--gold)] p-8 bg-[var(--surface)] text-center mb-6">
                    ...
                    <p className="text-[var(--text-muted)] text-sm mb-6">
                      We are currently finalizing this property. Online booking will be available shortly.
                    </p>
